<!--<template>-->
<!--  <div class="container">-->
<!--    <section style="padding-bottom: 550px;">-->
<!--      <h1 class="title" style="color: #1b1b1b; margin-top: -15px; font-family: Agency FB,serif;font-size: 100px">Recipes-->
<!--        web</h1>-->
<!--      &lt;!&ndash;    <img src="src/pages/.src/assets/pictures/background.jpg" alt="Logo" class="logo">&ndash;&gt;-->
...
<!--          <LoginPage class="comp"-->
<!--                     style="margin-top: -750px;padding-bottom: 230px;  padding-top: 200px;margin-right: -150px"></LoginPage>-->
<!--        </div>-->
<!--      </div>-->
<!--      &lt;!&ndash;      לסדר את 3 המתכונים שהמשתמש צפה לאחרונה    <li>&ndash;&gt;-->

<!--      <div id="UserLoggedIn" v-else>-->
<!--        <b-container fluid class="recipe-container" style="margin-top: -15px">-->
